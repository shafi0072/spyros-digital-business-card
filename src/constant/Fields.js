export const field_data = [
  ...
  },
  {
    ...
    fields: [
      {
        name: 'YouTube',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="32.421" height="28" viewBox="0 0 32.421 28">
      ...
      {
        name: 'Vimeo',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="33" height="28.811" viewBox="0 0 33 28.811">
  ...
  },
  {
    ...
    fields: [
      {
        name: 'PDF',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="27.248" height="33.489" viewBox="0 0 27.248 33.489">
      ...
      {
        name: 'Notes',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="31.543" height="32.103" viewBox="0 0 31.543 32.103">
      ...
      {
        name: 'Date',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="29.556" height="33" viewBox="0 0 29.556 33">
  ...
  },
  {
    ...
    fields: [
      {
        name: 'URL',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="30.841" height="30.841" viewBox="0 0 30.841 30.841">
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'Divider',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="3" viewBox="0 0 32 3">
