  ...
  return (
    <div className='mt-6 px-[10%] mb-[10%]'>
      ...
      <div className='border-b pb-3 mt-5'>
        ...
        <div className='flex items-center'>
          <div className='p-3 border-2 w-[10%] rounded'>
            <img className='w-[100%]' src={logoImage ? URL.createObjectURL(logoImage) : "https://d11a6trkgmumsb.cloudfront.net/original/3X/d/8/d8b5d0a738295345ebd8934b859fa1fca1c8c6ad.jpeg"} alt="" />
          </div>
