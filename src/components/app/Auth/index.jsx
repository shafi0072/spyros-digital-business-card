...
const index = () => {
  ...
  return (
    <div className='flex justify-center'>
      {!signUp && <div className='container w-[30%] content-center  border shadow-lg  p-5 mt-5 '>
      ...
      {signUp && <div className='container w-[30%] content-center  border shadow-lg  p-5 mt-5 '>
        <div className=" content-center ">
          <h2 className="mb-3 text-xl font-bold text-center">Sign Up</h2>
        ...
        <form onSubmit={handleSignUp} noValidate="" className="space-y-8 mb-5">
          ...
          <p className="text-sm text-center dark:text-gray-400">Already have an account?
            <button onClick={() => setSignUp(false)} rel="noopener noreferrer" className="focus:underline underline font-bold text-[#4285F4]">Sign Up </button>
            here
          </p>
          <div className='flex justify-center'>
            <button type="submit" className="w-48 px-8 py-3 font-semibold rounded-md bg-[#4285F4] hover:bg-[#1da1f2]/90 text-white ">Sign Up</button>
          </div>
        </form>
      </div>}
    </div>
